            ...
            <div className="sideContent">
                ...
                <div className="message-card" style={{ padding: '2rem' }}>
                                                ...
                                                allChats.map((chat, i) => {
                                                    return (
                                                        <div key={i} className="d-flex flex-row align-items-center gap-2 p-2" style={{
                                                            cursor: 'pointer',
                                                            borderBottom: '1px solid #c0c0c0', width: '90%'
                                                ...
                                                selectedUserId ? <>
                                                    ...
                                                    <div className='' style={{ color: '#636363', width: "100%" }}>
                                                        <div class="d-flex mb-3 my-3 ">
                                                            ...
                                                            <input
                                                                style={{ width: '100', background: '#fff', height: '8vh', borderRadius: '50px' }}
                                                                type="text"
                    ...
                    {show === true &&
                        <>
                            <div>
                                <h1 className='my-3' style={{ fontWeight: '700', width: '25%', borderBottom: "4px solid #3247ff", borderRadius: '5px', paddingBottom: '0.5rem' }}> <img src={message} alt="" /> Messages</h1>
                            </div>
