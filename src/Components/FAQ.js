                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><span >Of course! Acqify does not charge sellers for listing their assets; either they choose our basic pricing plan or premium.</span> <br />
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><span className='my-3'>Yes, we provide a quick valuation service to our sellers so they can easily make informed decisions on Acqify’s platform.</span><br />
                                <div className='my-4'></div>
                                </div>
                            </div>
                        </div>
