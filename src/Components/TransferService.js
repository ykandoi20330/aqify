...
const TransferService = () => {
    return (
        <>
                    ...
                    <div className='tamplate-logoBox d-flex' style={{ width: '100%' }}>
                        <div className='mx-2' style={{ width: '100%' }}>
                            <div className="card-tamplate ">
                                ...
                                <span>Microns act as a trusted middleman between buyer and seller. So they don't worry about stealing money or assets.</span>
                            </div>
                        </div>
                        <div className='mx-2' style={{ width: '100%' }}>
                            <div className="card-tamplate " >
                                <h3 className='my-3'>Great Customer Service</h3>
                                <span className='largeSpan'>We provide support during the transaction for both sides. We help with an agreement, handling payment, and tracking the transaction's status.</span>
                            </div>
                        </div>
                        <div className='mx-2' style={{ width: '100%' }}>
                            <div className="card-tamplate " >
                                <h3 className='my-3'>Blazingly Fast</h3>
                                <span>No more delays in the process because we optimize payment methods for both sides so that you can receive money within minutes.</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            < section className='fourth-main' >
                <div>
                    <div className='d-flex flex-column align-items-center justify-content-center mb-5'>
                        ...
                        <span className='text-center' style={{ color: '#636363' }}>From onboarding, we walk you through your acquisition process to complete transaction successfully.</span>
                    </div>
                </div>
                <div className='info-card'>
                    <div className="card-four align-items-center" >
                        <div class="emojitextbig" style={{ fontSize: '4rem' }}>🤝</div>
            ...
            <section className="FAQ-back" >
                <div>
                    <div className='d-flex flex-column align-items-start justify-content-start mb-5'>
                        <h2 className="listing-h1" style={{ marginTop: '10vh' }}>FAQ → </h2>
                    </div>
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><span >It's a service offered by Microns, a marketplace specializing in buying and selling small online startups. Transfer by Microns helps users securely close their deals by providing a service to ensure a smooth ownership transition.</span> <br />
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><span className='my-3'>Only Microns buyers or sellers can use the transfer service. The service is designed to help both parties in the transaction to complete the deal securely and fast.</span><br />
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><span className='my-3'>We conduct basic due diligence on the startups listed on our marketplace. They review basic metrics like revenue, traffic, and other relevant data points to ensure that the startups listed on our platform meet our quality standards. However, you must always arrange proper due diligence before buying any assets. </span><br />
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><span className='my-3'>After the agreement is signed, we handle payments and the transfer of assets. We also provide 24/7 email support to help the buyer and seller successfully close the deal.</span><br />
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFive" aria-expanded="false" aria-controls="flush-collapseFive">
                                    Who drafted the agreement, a contracts lawyer, or is it a generic one from somewhere online?
                                </button>
                                <img src="" alt="" />
                            </h2>
                            <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><span className='my-3'>We work with contract lawyers and financiers to draft agreements tailored to each transaction's specific needs. These agreements are not generic templates sourced from the internet.</span><br />
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><span className='my-3'>Once we receive the payment from the buyer, we notify the seller to send all assets upon agreement to the buyer. The buyer needs to review everything and do their due diligence.</span><br />
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <div className="d-flex flex-column align-items-center pb-4 pt-5" style={{ background: '#EEF0FE' }}>
                    <h2 className='fourth-h1'>Start your transfer today </h2>
                    <span style={{ color: 'rgb(99, 99, 99)' }}>
                        Acqify transfer service guarantees safe and comfy startup assets exchange — 24/7 support.
                    </span>
                </div>
                <div className="SignUp-back" style={{ background: '#EEF0FE'}}>
                    <div className="SignUp-second mx-2">
                        <div className="transferCard signUp-card my-5" style={{width:'100%'}}>
                            <div>
                                <div class=" mb-3 SignIn-input">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Startup Name" 
                                        name="userName" />
                                </div>
                            </div>
                            <div>
                                <div class=" mb-3 SignIn-input">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Owner Full Name" 
                                        name="userName" />
                                </div>
                            </div>
                            ...
                            <div>
                                <div class=" mb-3 SignIn-input">
                                    <input type="email" class="form-control" id="floatingInput" placeholder="Owner Email Address" 
                                        name="email" />
                                </div>
                            </div>
                            ...
                            <div>
                                <div class=" mb-3 SignIn-input">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Acquirer Full Name"
                                        name="userName" />
                                </div>
                            </div>
                            ...
                            <div>
                                <div class=" mb-3 SignIn-input">
                                    <input type="email" class="form-control" id="floatingInput" placeholder="Acquirer Email Address" 
                                    name="username"/>
                                </div>
                            </div>
                            ...
                            <div className="d-flex flex-column align-items-center my-3">
                                <span style={{ color: '#fff' }}>Who will pay the transfer fee?*</span>
                                <div className="d-flex my-2">
                                    ...
                                    <div >
                                        <input type="radio" class="btn-check  rounded-pill" name="options-base" id="option13" autocomplete="off"
                                            value="acquirer" />
                                        <label class="btn1" style={{ padding: "0.5rem", margin: '0.3rem 0.7rem 0 0', background: "#EEF0FE" }} for="option13">
                                            <i class="fa-solid fa-circle-check mx-2"></i>
                                            50/50</label>
                                    </div>
                                </div>
