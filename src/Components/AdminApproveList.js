        ...
        <>
            {show === true && <>
                ...
                <div className='d-flex flex-column align-items-start'>
                    ...
                    <div className='w-100'>
                        <div className="Approvedcard py-5" style={{ width: '95%' , cursor:'pointer'}}>
                            {filterSearch.map((card, index) => (
                                <div key={index} className='d-flex justify-content-between align-items-center py-2 px-5 rounded-pill my-2' onClick={() => detailPage(card)} style={{ background: '#EEF0FE' }}>
                                    <ul className='my-0'>
