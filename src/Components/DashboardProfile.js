                        ...
                        <div style={{ left: '0', transform: 'translateX(-100%)' }} class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                            ...
                            <div class="offcanvas-body" style={{ left: '0px' }}>
                                ...
                                <div class="Navdashboard d-flex flex-column flex-shrink-0 p-3 text-bg-dark" >
                                    ...
                                    <hr />
                                    <Link to="#" className='text-white' style={{ textDecoration: 'none' }} onClick={Show => setShow(1)}>
                                        <h2> Dashboard</h2>
                                    </Link>
                                    ...
                                    <div style={{ width: '60%' }}>
                                        ...
                                        <div>
                                            ...
                                            <div className='d-flex flex-wrap'>
                                                <div>
                                                    <input type="radio" class="btn-check  rounded-pill" name="options-base" id="option8" autocomplete="off" value="owner" onChange={handleChange} onClick={visible => setVisible(false)} />
                                                ...
                                                <div >
                                                    <input type="radio" class="btn-check  rounded-pill" name="options-base" id="option9" autocomplete="off" value="acquirer" onChange={handleChange} onClick={visible => setVisible(true)} />
                                                    <label class="btn1" style={{ padding: "0.5rem", margin: '0.3rem 0.7rem 0 0', background: "#EEF0FE" }} for="option9">
                                                        <i class="fa-solid fa-circle-check mx-2"></i>
                                                        Acquirer( buyer )</label>
                                                </div>
                                                <div>
                                                    <input type="radio" class="btn-check  rounded-pill" name="options-base" id="option10" autocomplete="off" value="owner and acquirer" onChange={handleChange} onClick={ChangeBoth} />
